/**
 *
 *   BRUHssian Roulette Copyright (C) 2019 Jacob Stelmachowske
 *   WheelView Copyright (C) 2014 Luke Deighton
 *
...
import com.stelmo.wheelview.adapter.WheelAdapter;
import com.stelmo.wheelview.transformer.FadingSelectionTransformer;
import com.stelmo.wheelview.transformer.ScalingItemTransformer;
import com.stelmo.wheelview.transformer.WheelItemTransformer;
import com.stelmo.wheelview.transformer.WheelSelectionTransformer;
...
public class WheelView extends View {
    ...
    private static final float VELOCITY_FRICTION_COEFFICIENT = 0.005f;
    private static final float CONSTANT_FRICTION_COEFFICIENT = 0.0015f;
    private static final float ANGULAR_VEL_COEFFICIENT = 22f;
    private static final float MAX_ANGULAR_VEL = 3.0f;
